                ...
                <nav aria-label="Site Nav" class="hidden md:block">
                    <ul class="flex items-center gap-6 text-sm">
                        ...
                        <li v-if="isAuthenticated">
                            <router-link to="/proyectos" class="text-gray-500 transition hover:text-gray-500/75">
                                Projectos
                            </router-link>
                        </li>
                        <li>
                            <a href="https://github.com/dcyar/todo-app-node-vue" target="_blank"
                                class="flex text-blue-600 font-bold border-b-4 border-blue-400">
                                Github
                        ...
                        <li>
                            <a href="https://github.com/dcyar" target="_blank"
                                class="flex text-blue-600 font-bold border-b-4 border-blue-400">
                                JhOn Achata
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="w-4 h-4 ml-1">
